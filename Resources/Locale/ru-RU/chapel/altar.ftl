...
altar-failure-reason-target = {CAPITALIZE($target)} {CONJUGATE-BE($target)} не обладает псионическими способностями.

altar-failure-reason-target-humanoid = {CAPITALIZE($target)} {CONJUGATE-BE($target)} не подходит по форме тела — нужен гуманоид.

altar-failure-reason-target-catatonic = {CAPITALIZE($target)} {CONJUGATE-BE($target)} в ступоре. Душа уже покинула его.
